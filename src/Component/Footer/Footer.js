        ...
        <>
            <div className='Footer' style={{ height:"40px", textAlign: "center", display:"flex", justifyContent:"center",placeItems:"center" }}>
                <ul style={{display:"flex", background:"none", marginTop:"15px"}}>
                    ...
                    <li style={{listStyle:"none", padding:"8px", background:"none"}}><a href='https://github.com/MritunjayKumarStudent' target="_blank"><i style={{color:"#FFCACA", background:"none", fontSize:"28px"}} class='bx bxl-github'></i></a></li>
